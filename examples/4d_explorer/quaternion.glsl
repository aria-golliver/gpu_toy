...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    quaternion c;
    c.d.x = (texture(texture_x, vec2(0,0)).x - .5) * 2;
    c.d.z = (texture(texture_y, vec2(0,0)).x - .5) * 2;
    c.d.y = (texture(texture_z, vec2(0,0)).x - .5) * 2;
    c.d.w = (texture(texture_w, vec2(0,0)).x - .5) * 2;
